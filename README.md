...
The world of the game is a stylized simulation of a Discord server, albeit exaggerated for comedic and emotional effect. Players assume digital avatars that represent their presence in the server, and each server channel acts as a thematic “zone” where certain kinds of humor and interaction take place, filled with familiar and exaggerated elements of internet culture: emojis, meme formats, reaction GIFs, and inside jokes. These elements are not simply visual gags; they build an environment that feels both ridiculous and deeply personal, echoing how online spaces blend humor with real emotion.
...
The game’s interface is styled like a stylized Discord window set against a customizable desktop background, evoking the everyday feel of late-night laptop conversations. Each “channel” (e.g., #general-chat, #photo-chat, etc.) is designed to resemble a real Discord thread, keeping the familiar layout of usernames, timestamps, and message bubbles, while small touches, such as animated message pop-ins or brief screen shake during chaotic moments, help build a more lived-in, personalized digital environment. The font will be pixelized just enough to give it a retro-digital texture, evoking the feeling of both early internet culture and modern social platforms.
